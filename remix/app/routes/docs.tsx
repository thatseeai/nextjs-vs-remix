...
export const meta: MetaFunction = () => {
  return [
    ...
    {
      name: "description",
      content: "Remix v2 프로젝트 문서 및 가이드",
    },
    { property: "og:title", content: "문서 - Remix App" },
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-gray-600 ml-11">
                  app/routes/ 폴더의 파일이 자동으로 라우트로 등록됩니다.
                  별도의 라우트 설정 파일이 필요 없습니다.
                </p>
              </div>
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-2 flex items-center">
