...
export const meta: MetaFunction = () => {
  return [
    { title: "게시글 목록 - Remix App" },
    {
      name: "description",
      content: "Remix App의 게시글 목록 페이지입니다.",
    },
  ];
};
...
export async function loader({ request }: LoaderFunctionArgs) {
  ...
  const posts: Post[] = [
    {
      id: "1",
      title: "Remix v2와 Vite로 시작하기",
      excerpt:
        "Remix v2에서 Vite를 빌드 도구로 사용하는 방법을 알아봅니다. Vite의 빠른 HMR과 Remix의 강력한 서버 사이드 기능을 결합하여 최고의 개발 경험을 제공합니다.",
      content: "Remix v2와 Vite에 대한 상세한 내용...",
      author: "홍길동",
    ...
    },
    {
      ...
      excerpt:
        "Remix의 핵심 개념인 loader와 action을 완벽하게 이해합니다. 서버 사이드에서 데이터를 읽고 쓰는 방법, 에러 처리, 그리고 최적화 기법을 다룹니다.",
