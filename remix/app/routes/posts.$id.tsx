...
export const meta: MetaFunction<typeof loader> = ({ data }) => {
  if (!data) {
    return [{ title: "게시글을 찾을 수 없습니다 - Remix App" }];
  }

  return [
    { title: `${data.post.title} - Remix App` },
...
export async function loader({ params }: LoaderFunctionArgs) {
  ...
  const posts: Record<string, Post> = {
    "1": {
      ...
      excerpt:
        "Remix v2에서 Vite를 빌드 도구로 사용하는 방법을 알아봅니다.",
      content: `
# Remix v2와 Vite 소개

Remix v2는 Vite를 공식 빌드 도구로 채택하여 개발 경험을 크게 향상시켰습니다.
...
Remix v2와 Vite의 조합은 최고의 개발 경험과 성능을 제공합니다.
기존 Remix 사용자도 마이그레이션을 고려해볼 만한 가치가 있습니다.
      `,
      author: "홍길동",
    ...
    "3": {
      ...
      excerpt: "Remix의 핵심 개념인 loader와 action을 완벽하게 이해합니다",
      content:
