 ...
 *
 * [신입 개발자를 위한 설명]
 * Remix에서는 각 라우트 파일에서 meta 함수를 export하여
...
export const meta: MetaFunction = () => {
  return [
    { title: "Remix v2 + Vite - Next.js 비교 프로젝트" },
    {
      name: "description",
      content:
        "Remix v2와 Next.js 15의 성능, 기능, 개발자 경험을 정량적으로 비교하는 프로젝트입니다.",
    },
    {
      name: "keywords",
      content:
        "Remix, Next.js, React, Vite, 비교, 성능, SSR, 웹 프레임워크",
    },
  ];
};
      ...
      <footer className="bg-white border-t border-gray-200 mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <p className="text-center text-gray-600">
            © 2025 Next.js vs Remix 비교 프로젝트. Remix v2.17.2 + Vite 6.x
          </p>
        </div>
      </footer>
    </div>
