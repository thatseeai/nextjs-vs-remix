 ...
 */
export const APP_NAME = "Remix App";
export const APP_DESCRIPTION =
  "Remix v2와 Vite를 활용한 현대적인 웹 애플리케이션";
export const APP_URL = process.env.PUBLIC_APP_URL || "http://localhost:5173";
export const APP_VERSION = process.env.VITE_APP_VERSION || "0.1.0";
...
export const API_BASE_URL =
  process.env.PUBLIC_API_URL || "http://localhost:5173/api";
 ...
 * 세션 및 토큰 관련 상수
 */
export const SESSION_COOKIE_NAME = "remix_session";
...
export const STORAGE_KEYS = {
  ...
  USER_PREFERENCES: "remix_user_preferences",
} as const;
