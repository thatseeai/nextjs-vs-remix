 ...
 * - 메타데이터 export를 통한 페이지 정보 설정
 *
 * [신입 개발자를 위한 설명]
 * 정적 라우트는 고정된 경로를 가진 페이지입니다.
 * Server Component는 서버에서 렌더링되어 클라이언트로 전송되므로
...
export const metadata: Metadata = {
  ...
  description: 'Next.js와 Remix 프레임워크 비교 프로젝트 소개',
};
        ...
        <Card>
          ...
          <CardBody>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <h3 className="text-lg font-semibold text-blue-600 mb-2">Next.js 버전</h3>
