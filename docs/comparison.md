...
> **📊 실측 데이터**: 이 문서의 성능 지표는 2025년 11월 18일 실제 측정한 데이터를 포함합니다.
...
|------|------------|----------|----------------|-----------|
| **전체 빌드 크기** | **9.5 MB** | **487 KB** | **496 KB** | **Remix** |
| 클라이언트 번들 | 677 KB | 353 KB | 357 KB | **Remix** |
| 서버 번들 | - | 130 KB | 135 KB | **Remix** |
| Vendor 청크 (gzip) | - | 84.73 KB | 86.98 KB | **Remix** |
| CSS 번들 | - | 21.74 KB | 21.51 KB | **RR7** |

**분석**:
- ⚠️ **Next.js가 압도적으로 큼**: 9.5 MB (Remix/RR7의 약 19배)
  - Pre-rendered 페이지 포함
  - 서버 사이드 코드 포함
  - Static 에셋 포함
- 🏆 **Remix가 가장 작은 번들**: 487 KB
- 📦 **React Router 7도 유사**: 496 KB (Remix 대비 +1.8%)
- ⚡ **Vite 최적화 효과**: Remix와 RR7 모두 효율적인 번들링
...
|------|------------------------|-----------------|----------------------|-----------|
| **프로덕션 빌드** | **18.624초** | **7.640초** | **6.975초** | **RR7** |
| 상대 속도 | 기준 (1.00x) | 2.44x 빠름 | 2.67x 빠름 | - |
| Client 번들 시간 | - | 2.49초 | 2.44초 | **RR7** |
| SSR 번들 시간 | - | 0.38초 | 0.49초 | **Remix** |
...
sys     0m1.720s
```
- Client: 2.44s, SSR: 494ms
- 가장 빠른 빌드 속도
- Next.js 대비 62.5% 빠름
- Remix 대비 8.7% 빠름

**핵심 발견사항**:
- ⚡ **React Router 7이 가장 빠름**: 6.975초
- 🚀 **Vite 빌드가 압도적**: Remix와 RR7 모두 Next.js 대비 2배 이상 빠름
- 📊 **Remix vs RR7**: 0.665초 차이 (RR7이 약 9% 빠름)
- ⏱️ **개발자 생산성**: 빌드 시간이 짧을수록 CI/CD 파이프라인 효율 증가
...
| 항목 | Next.js 16 | Remix v2 | React Router 7 | 최고 효율 |
|------|------------|----------|----------------|-----------|
| **node_modules** | **708 MB** | **239 MB** | **175 MB** | **RR7** |
| 상대 크기 | 기준 (1.00x) | 2.96x 작음 | 4.05x 작음 | - |
| 빌드 출력 | 9.5 MB | 487 KB | 496 KB | **Remix** |
| 총 디스크 사용 | ~720 MB | ~240 MB | ~176 MB | **RR7** |

**분석**:
- 🏆 **React Router 7이 가장 작은 디스크 사용**: 175 MB
  - Next.js 대비 75% 작음 (533 MB 절약)
  - Remix 대비 27% 작음 (64 MB 절약)
- 📦 **Remix도 효율적**: 239 MB (Next.js의 1/3)
- ⚠️ **Next.js가 가장 큼**: 708 MB
  - Turbopack 및 Next.js 전용 패키지 포함
  - 더 많은 내장 기능으로 인한 의존성 증가
- ⚡ **Vite 생태계의 장점**:
  - 경량 의존성
  - 효율적인 패키지 관리
  - 필요한 것만 설치
