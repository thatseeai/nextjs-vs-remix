 ...
 * 용도: Button 컴포넌트 유닛 테스트 (React Router 7)
 *
 * [Vitest 사용 이유]
 * - Vite 기반 React Router 7와 완벽한 통합
 * - 빠른 테스트 실행 속도
 * - HMR 지원
 *
 * [테스트 커버리지]
...
describe('Button 컴포넌트 (React Router 7)', () => {
  /**
   * [기본 렌더링 테스트]
   */
   ...
   * React Router 7의 특징: JavaScript 없이도 form 버튼은 작동해야 함
   */
